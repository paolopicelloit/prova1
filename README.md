...
Here we explain how to use **LTR Algorithms Execution** module to perform re-ranking starting from the files generated by **Features Extraction** module execution. The full working of the software is controlled by java properties file.
